...
| Type | Date | Room | Note|
| ------------- | ------------- | ------------- | ----- |
| Lab | 27/10/2022 11:00 | Google Meet | Please send your solutions to me by 24/10/2022. **Important:**  Please Cut&Paste your solutions to this [Jupyter Notebook](Lab/Solutions_NAME_SURNAME.ipynb) and **send me just this file** with your name and surname on its filename. Please read the very important note below. |
...
| 11/03/2022 | **Laboratory**: Applications of sorting (I). | | [Jupyter Notebook](Lab/Lecture_03/L03_Sorting_Applications_Greedy_Algorithms_no_sols.ipynb) **Mandatory exercises** |  
